...
:::note
**Terminology:** the canonical name for the protocol's node software is the **Open Audio Validator Node**. Earlier versions of Audius used separate *Discovery Nodes* and *Content Nodes* — both terms are deprecated and both roles are now served by validator nodes. See [Terminology](/concepts/terminology).
:::
