...
**`OPENAUDIO_REPAIR_CONCURRENCY`**  
<small>default: `1`</small>  
Number of CIDs the repair daemon processes in parallel within each batch. Default is serial; increase (e.g. `8`–`16`) to shorten run wall-time on I/O-bound workloads.
