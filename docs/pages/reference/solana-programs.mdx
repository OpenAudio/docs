...
This program powers the reward system, and allows Solana non-custodial token accounts to be
created for users that are represented by an Ethereum wallet. This program is also referred
to as the "User Bank".
