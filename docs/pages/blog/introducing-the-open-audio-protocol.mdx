...
layout: minimal
date: 2025-10-08
description: Version 1.0 of the protocol, reimagined as the Open Audio Protocol at openaudio.org, secured by $AUDIO.
authors: 
...
* A consolidation of the previous Audius node types — *Discovery Nodes* and *Content Nodes*, both now deprecated — into a single Open Audio Validator Node (reference implementation: [github.com/openaudio/go-openaudio](https://github.com/openaudio/go-openaudio))
