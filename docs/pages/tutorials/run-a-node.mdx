...
> - [`openaudio/go-openaudio:stable`](https://hub.docker.com/r/openaudio/go-openaudio) - latest official release
> - [`openaudio/go-openaudio:edge`](https://hub.docker.com/r/openaudio/go-openaudio) - latest committed code, tagged by commit hash
