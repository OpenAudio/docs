...
> - [`openaudio/go-openaudio:stable`](https://hub.docker.com/r/openaudio/go-openaudio) - latest official release, intended to be run by majority of network
> - `openaudio/go-openaudio:edge` - latest committed code, tagged by commit hash
