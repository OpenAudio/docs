...
> 1. Visit the [Audius Protocol Dashboard](https://staking.openaudio.org/#/nodes)
...
>
:::warning
If this is your last node, an unstake request will get created, visible on your operator page. Before continuing, you should cancel that request.
:::
> 5. Return to the nodes page of the [Audius Protocol Dashboard](https://staking.openaudio.org/#/nodes)
